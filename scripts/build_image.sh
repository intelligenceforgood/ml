...
set -euo pipefail
# ---------------------------------------------------------------------------
# Build and push ML Docker images to Artifact Registry.
#
# Usage:
...
Options:
  ...
  -i, --image IMAGE        Override full image tag
      --registry PREFIX    Registry/repo prefix (default: us-central1-docker.pkg.dev/i4g-ml/containers)
...
DOCKERFILE=""
IMAGE_TAG=""
REGISTRY_PREFIX="us-central1-docker.pkg.dev/i4g-ml/containers"
NO_CACHE="false"
EXTRA_BUILD_ARGS=()
POSITIONAL=()
